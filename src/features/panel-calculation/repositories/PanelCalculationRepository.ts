...
export class PanelCalculationRepository extends BaseRepository<CalculationRecord> {
...
export const panelCalculationRepository = new PanelCalculationRepository();
